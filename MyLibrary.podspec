...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Chin W Chai/MyLibrary'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Chin W Chai' => 'c@c.com' }
  s.source           = { :git => 'https://github.com/Chin W Chai/MyLibrary.git', :tag => s.version.to_s }
